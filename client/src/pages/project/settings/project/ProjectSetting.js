    ...
    if (isValid) {
      this.props.editProject(projectId, projectData, res => {
        if (res.status === 200) {
          ...
          this.props.history.push(`/${projectId}/ProjectInfo`);
        } else {
          failToast("Editing project failed");
          this.props.history.push(`/${projectId}/ProjectSetting`);
        }
      });
    } else {
      this.setState({ errors });
    ...
    if (this.state.deleted) {
      ...
      editUserBtn = (
        <div className="flex-column-left mt-4">
          ...
          />
          <UnderlineAnchor link={`/${this.props.match.params.projectId}/ProjectInfo`} value={"Cancel"} />
        </div>
      );
    }
      ...
      <div className="wrapper">
        ...
        <div className="main-content main-content-grid">
          <Header
            ...
            history={this.props}
            canGoBack={true}
            link={`/${this.props.match.params.projectId}/ProjectInfo`}
          />
